...
function BudgetItem({ budget }: { budget: Budget }) {
    const calculateProgressPerc = () => {
        const perc = (budget.totalSpent / Number(budget.amount)) * 100;
    ...
    hover:shadow-md cursor-pointer h-[170px]"
            >
              ...
              "
                    ...
                    <h2 className="font-bold text-primary text-lg"> ${Number(budget.amount)}</h2>
                </div>
                ...
                <div className="mt-5">
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <h2 className="text-xs text-slate-400">
                            ${Number(budget.amount) - budget.totalSpent} Remaining
                        </h2>
                    </div>
                    <div
                        className="w-full
